...
var TipoEstablecimientoService = (function () {
    ...
    TipoEstablecimientoService.prototype.handleError = function (error) {
        console.log(error.json());
        return Rx_1.Observable.throw(error.json().error || 'Server error');
    };
    TipoEstablecimientoService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], TipoEstablecimientoService);
    return TipoEstablecimientoService;
}());
exports.TipoEstablecimientoService = TipoEstablecimientoService;
//# sourceMappingURL=tipoEstablecimiento.service.js.map