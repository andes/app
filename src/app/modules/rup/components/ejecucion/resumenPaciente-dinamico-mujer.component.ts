...
@Component({
    selector: 'rup-resumenPaciente-dinamico-mujer',
    templateUrl: 'resumenPaciente-dinamico-mujer.html'
})

export class ResumenPacienteDinamicoMujerComponent implements OnInit {
