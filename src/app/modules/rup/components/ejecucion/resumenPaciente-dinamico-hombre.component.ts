...
@Component({
    selector: 'rup-resumenPaciente-dinamico-hombre',
    templateUrl: 'resumenPaciente-dinamico-hombre.html'
})

export class ResumenPacienteDinamicoHombreComponent implements OnInit {
