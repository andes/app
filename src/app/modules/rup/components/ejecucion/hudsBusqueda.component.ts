            ...
            this.prestaciones = groupBy(validadas).map(p => {
                if (Array.isArray(p)) {
                    return {
                        ...
                        profesional: p[0].solicitud.profesional.nombre + ' ' + p[0].solicitud.profesional.apellido,
                    ...
                    return {
                        ...
                        profesional: p.solicitud.profesional.nombre + ' ' + p.solicitud.profesional.apellido,
