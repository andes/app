...
@Component({
    selector: 'rup-consulta-adolescente-sano',
    templateUrl: 'consultaAdolescenteSano.html'
})
@RupElement('ConsultaAdolescenteSanoComponent')
export class ConsultaAdolescenteSanoComponent extends RUPComponent implements OnInit {
    ninoSanoHUDS: any;
    ultimaConsulta: any;
