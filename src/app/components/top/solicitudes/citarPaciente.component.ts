...
@Component({
    selector: 'citar-paciente',
    templateUrl: './citarPaciente.html',
    styleUrls: ['adjuntarDocumento.scss'],
})
export class CitarPacienteComponent implements OnInit {
    ...
    confirmarCitar() {
        this.returnCitar.emit({ status: false, motivo: this.motivo });
    }
