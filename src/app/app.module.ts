...
@NgModule({
  ...
  declarations: [AppComponent, OrganizacionComponent, OrganizacionCreateComponent, OrganizacionUpdateComponent,
   EspecialidadComponent, EspecialidadCreateComponent,EspecialidadUpdateComponent, 
   ProfesionalComponent, ProfesionalUpdateComponent,ProfesionalCreateComponent, PacienteCreateComponent, PacienteComponent, PacienteUpdateComponent],
